...
window.goatcounter = {
  endpoint: "https://nelsonfigueroa.goatcounter.com/count",
};
(function () {
  "use strict";
...
var Util = /*#__PURE__*/ (function () {
  ...
  _createClass(Util, [
    ...
    {
      // removing things here broke stuff. animateCSS has been removed though
      key: "animateCSS",
      value: function animateCSS(element, animation, reserved, callback) {
        ...
        (_element$classList = element.classList).add.apply(
          _element$classList,
          ["idk"].concat(_toConsumableArray(animation)),
        );
          ...
          this._tocOnScroll =
            ...
            function () {
              ...
              for (var i = 0; i < $headerLinkElements.length - 1; i++) {
                ...
                var thisTop =
                  $headerLinkElements[i].getBoundingClientRect().top - 90;
                var nextTop =
                  $headerLinkElements[i + 1].getBoundingClientRect().top - 90;
