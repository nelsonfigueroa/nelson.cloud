...
The tool will go through every password in the wordlist and try to crack the access point's password. Wordlists are convenient and can be fast, but if the password is not in the wordlist itself, we'll need to try bruteforcing.
