...
This post covers Instance Metadata Service Version 1 (IMDSv1). For security purposes, it is recommended that you use IMDSv2. I created a separate post covering IMDSv2 here: [Getting EC2 Instance Metadata Using IMDSv2]({{< ref "/posts/2023-12-01-ec2-metadata-using-imdsv2" >}})
{{< /admonition >}}
