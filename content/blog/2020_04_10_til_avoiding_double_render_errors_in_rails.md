+++
title = "TIL: Avoiding AbstractController::DoubleRenderError in Rails"
description = "Prevent Rails from throwing errors when including two redirects in an action"
date = "2020-04-10"
