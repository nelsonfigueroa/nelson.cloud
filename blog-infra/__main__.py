...
# IAM users
hugo_user = aws.iam.User(
    "hugo",
    name="hugo",
)

personal_laptop_user = aws.iam.User(
    "personal-laptop",
    name="personal-laptop",
)

# IAM policy attachments for IAM users
personal_laptop_admin = aws.iam.UserPolicyAttachment(
    "personal-laptop-admin",
    user=personal_laptop_user.name,
    policy_arn="arn:aws:iam::aws:policy/AdministratorAccess",
)

hugo_s3_full_access = aws.iam.UserPolicyAttachment(
    "hugo-s3-full-access",
    user=hugo_user.name,
    policy_arn="arn:aws:iam::aws:policy/AmazonS3FullAccess",
)

hugo_cloudfront_full_access = aws.iam.UserPolicyAttachment(
    "hugo-cloudfront-full-access",
    user=hugo_user.name,
...
nelsonfigueroa_dev_distribution = aws.cloudfront.Distribution(
    "nelsonfigueroa-dev",
...
nelson_cloud_distribution = aws.cloudfront.Distribution(
    "nelson-cloud",
...
# ACM Certificates
nelsonfigueroa_sh_certificate = aws.acm.Certificate(
    "nelsonfigueroa-sh",
...
nelsonfigueroa_dev_certificate = aws.acm.Certificate(
    "nelsonfigueroa-dev",
...
nelson_cloud_certificate = aws.acm.Certificate(
    "nelson-cloud",
...
# Route 53 Zones
nelsonfigueroa_dev_zone = aws.route53.Zone(
    "nelsonfigueroa-dev",
    comment="",
...
nelson_cloud_zone = aws.route53.Zone(
    "nelson-cloud",
    comment="",
    name="nelson.cloud",
    opts=pulumi.ResourceOptions(protect=True),
...
nelsonfigueroa_dev_a = aws.route53.Record(
    "nelsonfigueroa-dev-a",
    aliases=[
        {
...
nelsonfigueroa_dev_aaaa = aws.route53.Record(
    "nelsonfigueroa-dev-aaaa",
    aliases=[
        {
            "evaluate_target_health": False,
            "name": "d21xfi3nko5ufm.cloudfront.net",
...
nelsonfigueroa_dev_mx = aws.route53.Record(
    "nelsonfigueroa-dev-mx",
    name="nelsonfigueroa.dev",
    records=["0 ."],
    ttl=300,
...
nelsonfigueroa_dev_txt = aws.route53.Record(
    "nelsonfigueroa-dev-txt",
    name="nelsonfigueroa.dev",
    records=[
        "google-site-verification=Z6XialAUrcY8MKzEaYpfzsJ5YMg9k9Et11shkMS_ZWwl; v=spf1 -all;"
    ],
    ttl=300,
...
nelsonfigueroa_dev_wildcard_txt = aws.route53.Record(
    "nelsonfigueroa-dev-wildcard-txt",
    name="*.nelsonfigueroa.dev",
    records=["v=spf1 -all"],
    ttl=300,
    type=aws.route53.RecordType.TXT,
...
nelsonfigueroa_dev_acm_validation = aws.route53.Record(
    "nelsonfigueroa-dev-acm-validation",
...
nelsonfigueroa_dev_dmarc = aws.route53.Record(
    "nelsonfigueroa-dev-dmarc",
...
nelsonfigueroa_dev_dkim = aws.route53.Record(
    "nelsonfigueroa-dev-dkim",
...
nelson_cloud_a = aws.route53.Record(
    "nelson-cloud-a",
    aliases=[
        {
            "evaluate_target_health": False,
...
nelson_cloud_aaaa = aws.route53.Record(
    "nelson-cloud-aaaa",
    aliases=[
        {
            "evaluate_target_health": False,
...
nelson_cloud_mx = aws.route53.Record(
    "nelson-cloud-mx",
    name="nelson.cloud",
    records=[
...
nelson_cloud_txt = aws.route53.Record(
    "nelson-cloud-txt",
    name="nelson.cloud",
    records=[
...
nelson_cloud_acm_validation = aws.route53.Record(
    "nelson-cloud-acm-validation",
...
nelson_cloud_dkim = aws.route53.Record(
    "nelson-cloud-dkim",
